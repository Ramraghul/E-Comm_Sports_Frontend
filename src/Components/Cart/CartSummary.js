  ...
  return (
   ...
   <div className="col-md-4">
        <div className="card mb-4">
          ...
          <h5 className="fst-italic" style={{textAlign:"center"}}>powered by <img style={{width:"200px",height:"50px"}} src="https://www.j2store.org/images/extensions/payment_plugins/Razorpay.png" alt="Pay"/></h5>
          </>
           }
          </div>
        </div>
